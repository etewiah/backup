...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "addressable", "~> 2.7" # "= 2.3.5"
  ...
  gem.add_dependency "faraday", "1.8.0" # "= 0.8.8"
  ...
  gem.add_dependency "thor", "1.1.0" #, "= 0.18.1"
